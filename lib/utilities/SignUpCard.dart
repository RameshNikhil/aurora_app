...
class SignUpCard extends StatefulWidget {
  ...
  SignUpCard(
      {@required this.title, @required this.detail, @required this.trigger});

  @override
  _SignUpCardState createState() => new _SignUpCardState();
}
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: 15.0, bottom: 40.0),
                                    child: Text(
                                      "Tap on a tile to complete the task.",
                                      style: TextStyle(
                                        fontSize: 15.0,
                                      ),
                                    ),
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: 15.0, bottom: 40.0),
                                    child: Text(
                                      "Swipe left to access your stats dashboard.",
                                      style: TextStyle(
                                        fontSize: 15.0,
                                      ),
                                    ),
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: 15.0, bottom: 40.0),
                                    child: Text(
                                      "Swipe right to access anytime chat",
                                      style: TextStyle(
                                        fontSize: 15.0,
                                      ),
                                    ),
